...
class Slider {
    ...
    this.images = [
        ...
        './src/assets/images/sliderbg2.jpg',
        './src/assets/images/sliderbg3.png'
      ]
      this.data = {
        current: 0,
        next: 1,
    ...
    loadTextures() {
      ...
      this.disp = loader.load('./src/assets/images/disp_reference.png', this.render)
    ...
    timer(){
      window.setInterval(this.nextSlide, 3500);
    }
